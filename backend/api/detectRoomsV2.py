...
USER_PROMPT = (
    ...
    "4. Calculate wall dimensions between consecutive vertices.\n"
    "5. Calculate the total area (square footage) for each room.\n"
    "6. Normalize room types (e.g., 'Gymnasium' -> 'gym', 'Restroom' -> 'bathroom').\n\n"
