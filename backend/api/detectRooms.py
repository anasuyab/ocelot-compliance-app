...
USER_PROMPT = (
    ...
    "Estimate the textual dimensions (e.g., '100ft x 50ft' or '20ft Diameter') based on the scale markers in the image. "
    "Maintain the unit (e.g. ft vs m) as per the scale in image"
    "(0,0) is defined as the top-left corner of the image"
